...
# Template: app
# Command: C:\Qt\6.4.2\mingw_64\bin\qmake.exe -o Makefile audioPlayer.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
#############################################################################
...
Makefile: audioPlayer.pro C:/Qt/6.4.2/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.4.2/mingw_64/mkspecs/features/spec_pre.prf \
		...
		audioPlayer.pro \
		C:/Qt/6.4.2/mingw_64/lib/Qt6Multimedia.prl \
	...
	$(QMAKE) -o Makefile audioPlayer.pro -spec win32-g++ "CONFIG+=qtquickcompiler"
